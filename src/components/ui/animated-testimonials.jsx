          ...
          >
            ...
            <motion.div className="flex items-center justify-center mt-4">
              <button
                ...
                onClick={() =>
                  window.open(
                    "https://docs.google.com/document/d/1VlDVwnCMnBXQM61nArCS7N-D0jKf5CFn/edit?usp=drive_link&ouid=104369214369623533841&rtpof=true&sd=true",
                    "_blank",
                    "noopener,noreferrer"
                  )
                }
          ...
          <div className="hidden md:flex gap-4 pt-12 md:pt-0">
            <div className="flex items-center justify-between gap-8">
              ...
              <motion.button
                ...
                onClick={() =>
                  window.open(
                    "hhttps://docs.google.com/document/d/1VlDVwnCMnBXQM61nArCS7N-D0jKf5CFn/edit",
                    "_blank",
                    "noopener,noreferrer"
                  )
                }
